...
```
Comments for Q14
Specify a column in the code from which you want to calculate the summary statistics for, this is to prevent you from hard-coding.This would enable you use this code on any data set for similar purpose.
...
Comments for Q15
Specify a column in the code from which you want to calculate the mean, this is to prevent you from hard-coding.This would enable you use this code on any data set for similar purpose.
